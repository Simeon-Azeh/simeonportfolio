...
function AboutHero() {
  ...
  return (
    <div className='bg-light-body dark:bg-dark-body transition-colors pb-4'>
        <div className='text-2xl md:text-4xl font-medium dark:text-slate-50 text-light-text  flex gap-2 md:gap-4 items-center w-full md:w-4/5 mx-auto font-inter px-6 md:px-0 '>
            I am a{' '}
