...
function AboutHero() {
  ...
  return (
    <div className='bg-[#F9FEFF] dark:bg-dark-body transition-colors '>
        <div className=' text-4xl font-medium dark:text-slate-50 text-[#414760]  flex gap-4 items-center w-full md:w-4/5 mx-auto font-inter px-4 md:px-0 '>
            I am a{' '}
            <span className={`inline-block text-4xl transition-all duration-500 dark:text-slate-300 text-orange-500 ${fade ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
              {currentRole}
            </span>
          </div>
    </div>
