...
const ContactForm = () => {
  ...
  return (
    <div className="bg-white dark:bg-dark-body font-inter">
        <div  onSubmit={handleSubmit} className=' font-inter px-6 py-6 border dark:border-gray-700 dark:border-solid rounded'>
        <h2 className="text-2xl md:text-4xl font-medium mb-2 text-light-text dark:text-gray-200 ">Contact Me</h2>
      <div className="mb-4">
