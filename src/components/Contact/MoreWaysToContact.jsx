...
const MoreWaysToContact = () => {
  ...
  return (
    <div className="bg-white dark:bg-dark-body font-inter">
      <div className='font-inter px-4 py-4 border dark:border-gray-700 dark:border-solid rounded'>
        <ul className="space-y-4">
          <li className="flex items-center justify-between border dark:border-gray-700 dark:border-solid p-2 rounded">
            ...
            <button
              ...
              className='border dark:border-gray-700 dark:border-solid rounded py-1 px-2 cursor-pointer flex items-center gap-1 text-light-text'>
