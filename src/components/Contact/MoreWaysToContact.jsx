              ...
              {contactMethods.map((method, index) => (
                ...
                >
                  <div className="flex items-center mb-3 sm:mb-0">
                    <div className="w-10 h-10 rounded-full bg-pink-100 dark:bg-white/20 text-pink-600 dark:text-white flex items-center justify-center mr-4 flex-shrink-0">
                      {method.icon}
                    </div>
                    <div>
                      ...
                      <a 
                        href={method.link} 
                        className="text-gray-800 dark:text-white font-medium hover:text-pink-600 dark:hover:text-pink-400 transition-colors"
                      >
                        {method.value}
                      </a>
                    </div>
                  ...
                  {method.action === 'copy' ? (
                    ...
                    <motion.a
                      ...
                      whileTap={{ scale: 0.95 }}
                      className="flex items-center justify-center px-4 py-2 rounded-lg bg-pink-100 dark:bg-pink-900/30 text-pink-700 dark:text-pink-400 text-sm font-medium hover:bg-pink-200 dark:hover:bg-pink-900/50 transition-colors"
                    >
