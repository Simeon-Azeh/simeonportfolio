    ...
    <div className="bg-[#F9FEFF] dark:bg-dark-body transition-colors">
      <div className='flex justify-between w-full md:w-4/5 mx-auto items-center py-4 px-6 md:px-0 font-inter sticky top-0 z-50'>
        ...
        <div className="hidden md:flex space-x-6 text-[#414760] dark:text-slate-50">
          <Link to="/">
            <a className="hover:border-b-2 border-gray-400">Home</a>
          </Link>
          <div className="relative">
            ...
            {dropdownOpen && (
              <div className="absolute bg-[#1a1818] text-white py-2 mt-2 space-y-2 rounded border border-gray-600">
                <Link to="/resume">
                  <p className="block py-2 px-4">Resume</p>
                </Link>
                <Link to="/portfolio">
                  <p className="block py-2 px-4">Portfolio</p>
                </Link>
              </div>
            )}
          </div>
          <Link to="/services">
            <a className="hover:border-b-2 border-gray-400">Services</a>
          </Link>
          <Link to="/contact">
            <a className="hover:border-b-2 border-gray-400">Contact</a>
          </Link>
        </div>
        <div className="hidden md:flex items-center space-x-4">
          ...
          />
          <a href="https://www.facebook.com/kongnyuy.simeon.3?mibextid=ZbWKwL" target="_blank" rel="noopener noreferrer" className="hover:text-gray-400 dark:text-slate-50 text-[#414760]">
            <FaFacebook size={20} />
          </a>
          <a href="https://www.linkedin.com/in/simeonazeh?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noopener noreferrer" className="hover:text-gray-400 dark:text-slate-50 text-[#414760]">
            <FaLinkedin size={20} />
          </a>
          <a href="https://github.com/Simeon-Azeh" target="_blank" rel="noopener noreferrer" className="hover:text-gray-400 dark:text-slate-50 text-[#414760]">
            <FaGithub size={20} />
          </a>
        </div>
      ...
      <Drawer title="Menu" placement="right" onClose={onClose} visible={visible} className='bg-[#f7f7f7] font-inter font-medium'>
        <Link to="/">
          <a className="block py-2 px-4 text-[#2c2b2b] hover:text-[#2c2b2b]">Home</a>
        </Link>
        <Link to="/resume">
          <a className="block py-2 px-4 text-[#2c2b2b] hover:text-[#2c2b2b]">Resume</a>
        </Link>
        <Link to="/services">
          <a className="block py-2 px-4 text-[#2c2b2b] hover:text-[#2c2b2b]">Services</a>
        </Link>
        <Link to="/portfolio">
          <a className="block py-2 px-4 text-[#2c2b2b] hover:text-[#2c2b2b]">Portfolio</a>
        </Link>
        <Link to="/contact">
