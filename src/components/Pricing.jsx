...
const PricingCard = ({ icon: Icon, title, pricingType, price, description, features, buttonLabel }) => (
  <div className="bg-light-body dark:bg-[#1B1B1A] p-6 rounded-lg  w-full md:w-2/5  mx-4 mb-6 border dark:border-gray-700 dark:border-solid font-inter">
    ...
    <div className="bg-white dot-pattern dark:bg-dark-body transition-colors py-10 px-4">
      <div className="w-full md:w-4/5 mx-auto">
        ...
        <div className="flex items-center justify-between flex-col md:flex-row  bg-light-body dark:bg-[#1B1B1A] px-6 py-6 rounded-lg  w-full mt-6 border dark:border-gray-800 dark:border-solid font-inter">
            ...
            <Link to="/contact" className='bg-pink-600 dark:border flex w-full items-center justify-center md:w-1/6  dark:border-gray-700 dark:border-solid dark:bg-dark-body text-white px-4 py-2 rounded-lg hover:translate-y-[-3px] duration-300'>
            Let's talk
            </Link>
