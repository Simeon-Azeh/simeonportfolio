...
function TestimonialCard({ name, position, image, text }) {
  ...
  return (
    <div className='w-full md:w-4/5 mx-auto my-10 font-inter px-6 md:px-0'>
      <h2 className='text-2xl md:text-4xl mb-2 dark:text-slate-50 text-light-text'>{t('testimonial_title')}</h2>
      <p className='text-[15px] dark:text-slate-300 text-light-text my-4'>{t('testimonial_intro')}</p>
      <div className="font-inter">
        ...
        <h4 className="text-lg font-semibold mb-2 text-light-text dark:text-gray-200">{t('testimonial_header')}</h4>
