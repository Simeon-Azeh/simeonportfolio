  ...
  return (
    <div className='bg-white dark:bg-dark-body transition-colors font-inter'>
      <div className='w-full md:w-4/5 mx-auto pt-6 px-6 md:px-0'>
        ...
        <div>
            <ul className='text-[15px] dark:text-slate-50 mt-4 text-[#6b7280] space-y-4'>
        ...
        <p className='text-[15px] dark:text-slate-300 text-[#6b7280] my-4'>Your product is treated as ours with a primary goal of your uncompromised satisfaction ⏤ your success equals our success.</p>
      </div>
    </div>
  )
}
